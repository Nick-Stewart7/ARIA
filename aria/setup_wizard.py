...
def generate_env_file(provider:str, api_key:str, host:str, port:str, tavily_key:str, user:str, period:str):
...
def run_setup():
    ...
    try:
        ...
        generate_env_file(provider=provider, api_key=api_key, host=host, port=port, tavily_key=tavily_key, user=user, period=heartbeat_period)
